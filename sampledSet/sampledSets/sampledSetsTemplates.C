...
template<class Type>
Foam::mySampledSets::volFieldSampler<Type>::volFieldSampler
(
    const word& interpolationScheme,
    const GeometricField<Type, fvPatchField, volMesh>& field,
    const PtrList<mySampledSet>& samplers
)
:
    ...
    name_(field.name())
{
    ...
    forAll(samplers, setI)
    {
        ...
        const mySampledSet& samples = samplers[setI];
...
template<class Type>
Foam::fileName Foam::mySampledSets::writeSampleFile
(
...
template<class T>
void Foam::mySampledSets::combineSampledValues
(
...
template<class Type>
void Foam::mySampledSets::sampleAndWrite(fieldGroup<Type>& fields)
{
    if (fields.size())
    {
        ...
        forAll(fields, fieldi)
        {
            ...
            {
                Pout<< "mySampledSets::sampleAndWrite: "
                    << fields[fieldi] << endl;
            }
